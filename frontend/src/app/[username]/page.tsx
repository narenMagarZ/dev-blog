...
export default function Username(){
    return(
        <div>
            <div className="bg-blue-600 w-full h-[100px]"></div>
                ...
                <div className="bg-white border w-[600px] rounded flex flex-col items-center relative gap-y-1 p-2">
                    <div className="">
                        <div className="mt-[-40px] text-center mb-4">
                            <button className="p-12 rounded-full bg-slate-200 border-4 border-blue-600"></button>
                        </div>
                        <button className="right-2 top-2 absolute right-0 rounded text-sm text-white bg-blue-600 p-2">
                            Edit profile
                        </button>
                    </div>
